...
class Crystal:
    ...
    def __init__(self, crys_array_dict):
        ...
        # assert self.lengths.ndim == 1
        self.lattices = crys_array_dict["lattices"]
    ...
    def get_structure(self):
        ...
        if np.isnan(self.frac_coords).any():
    ...
    def __repr__(self):
        return f"Crystal(valid={self.valid}, atoms={self.atom_types}, lattices={self.lattices}, frac_coords={self.frac_coords}, idx={self.sample_idx})"
