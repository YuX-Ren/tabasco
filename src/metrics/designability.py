...
from tabasco.utils.align_utils.align_utils import kabsch_align_ind
from tabasco.utils.ff_utils.pdb_utils import from_pdb_string
...
def run_and_store_esm(
    ...
    if max_nres > 700:
        ...
        batch_size = 2
        num_batches = len(seqs) // 2
    else:
        batch_size = 4
        num_batches = len(seqs) // 4
    if num_batches == 0:
        num_batches = 1
